<template>
  <div class="Navbar">
    <nav id="nav" class="navbar navbar-expand-lg mb-5" style="background-color: #e3f2fd;">
    <div class="container-fluid">
      <router-link class="navbar-brand active" to="/">Navbar</router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarColor03">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
           <router-link class="nav-link active" to="/register" v-if="!$store.state.isAuthenticated">Register</router-link>
          </li>
          <li class="nav-item">
